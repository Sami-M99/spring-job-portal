...
import com.sami.backend_demo.dto.UserDto;
...
public class UserController {
    ...
    // جعل Path Variable اختيارية (Optional) 🚩
    ...
    // ربط Placeholder باسم متغير مختلف 🚩
    ...
    // استقبال عدد كبير من Path Variables باستخدام Map 🚩
    ...
    // جعل Query Parameter اختيارياً + إعطاء قيمة افتراضية + تغيير اسم المتغير 🚩
    @GetMapping("/search")
    ...
    // استقبال عدد غير محدود من Query Parameters 🚩
